                        ...
                        <div class="right">
                            <div class="log-in">
                                ...
                                <form class="py-3" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" placeholder="請輸入密碼" required>
                                ...
                                <button type="button" class="btn btn-primary btn-lg w-100 my-botton">{{ __('Login') }}</button>
